  ...
  >
    ...
    >
      ...
      >
        ...
        >
          <h1 class="text-h2 text-h1-md font-weight-bold white--text mb-4 main-title">
            Отличный день для кофе
          </h1>
        </Motion>
      ...
      >
        ...
        >
          <v-card
            ...
            dark
          >
            <v-card-title class="text-h5 font-weight-bold section-title">
